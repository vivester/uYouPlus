...
$(TWEAK_NAME)_INJECT_DYLIBS = $(THEOS_OBJ_DIR)/iSponsorBlock.dylib $(THEOS_OBJ_DIR)/YoutubeSpeed.dylib $(THEOS_OBJ_DIR)/libFLEX.dylib  Tweaks/uYou/Library/MobileSubstrate/DynamicLibraries/uYou.dylib
...
ifneq ($(JAILBROKEN),1)
SUBPROJECTS += Tweaks/Alderis Tweaks/iSponsorBlock Tweaks/YTSpeed Tweaks/FLEXing/libflex
